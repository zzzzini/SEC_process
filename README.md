...
# 📖 Split learning
## 💡 idea
- 2018년 MIT에서 제시한 분할학습은 클라이언트가 모델의 앞부분을 학습하고 서버가 뒷부분을 학습하는 방법으로, 각 학습의 가중치가 반영되기가 어려움
...
👉🏻 **실시간으로 안전한 데이터 결합이 가능**하므로, 고도화된 크로스 도메인 추천 시스템, 개인화 서비스 등의 개발에 활용될 수 있음
